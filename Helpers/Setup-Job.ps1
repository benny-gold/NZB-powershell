...
$JobTrigger = New-JobTrigger -At $((get-date).AddSeconds(30)) -RepeatIndefinitely -RepetitionInterval (New-TimeSpan -Minutes (Get-Random -Minimum 720 -Maximum 780)) -Once
